/*
 ...
 Usage:
  npm run test-fixtures -- [--fixtures fixtures/figma] [--pattern name-substring] [--threshold 2.5] [--size-tolerance-percent 2.5] [--server http://localhost:7789] [--timeout-ms 15000]
...
function parseArgs(argv: string[]): CliArgs {
  ...
  let server = 'http://localhost:7789';
  let timeoutMs = 15000;
